...
namespace G7FlappyBird.Scenes
{
    public class ThemeScene : IScene
    {
        ...
        private Texture2D _themeBirdsTexture;
        private Texture2D _themeInkTexture;
        ...
        public void LoadContent()
        {
            ...
            _themeBirdsTexture = _content.Load<Texture2D>("themeBirds");
            _themeInkTexture = _content.Load<Texture2D>("themeInk");
            ...
            _themeInkPosition = new Vector2(buttonCenterX + 15, _themeBirdsPosition.Y + _themeBirdsTexture.Height + _buttonSpacing);
            _menuButtonPosition = new Vector2(buttonCenterX, _themeInkPosition.Y + _themeInkTexture.Height + _buttonSpacing);
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(_themeBirdsTexture, _themeBirdsPosition, Color.White);
            spriteBatch.Draw(_themeInkTexture, _themeInkPosition, Color.White);
