...
namespace G7FlappyBird.Scenes
{
    public class HelpScene : IScene
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            string helpText = "The game is simple. Tap the screen to make the little bird \"flap\" \nand have some vertical velocity. After that, " +
                "the bird falls. The\n goal is to get the bird to \"fly-fall\" through some openings in pipes.";
